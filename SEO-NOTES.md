...
| Page | Primary intent |
| --- | --- |
| /ai-resenja | AI rešenja za firme, AI rešenja Srbija |
| /ai-automatizacija | AI automatizacija poslovanja, automatizacija biznisa |
| /blog/ai-obrada-faktura-kalkula | AI obrada faktura, primer automatizacije robnih kalkulacija |
| /blog/kako-poceti-sa-ai-automatizacijom | kako početi sa AI automatizacijom |

These are editorial targets, not measured search volumes or ranking promises.
...
6. Measure qualified inquiries as well as traffic. Current GA is consent-gated. No Search Console baseline justifies a ranking forecast yet.

## Limitations to address separately

- English text currently changes in JavaScript on the same URL. Do not add hreflang until separate stable language URLs exist.
- Career JobPosting data is embedded in the homepage; proper individual job URLs and expiry handling need a separate content pass.
- No ongoing monitoring automation has been requested or created.
